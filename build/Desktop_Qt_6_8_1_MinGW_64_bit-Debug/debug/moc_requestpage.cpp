...
static constexpr auto qt_meta_stringdata_ZN11RequestPageE = QtMocHelpers::stringData(
    "RequestPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11RequestPageE[] = {
...
Q_CONSTINIT const QMetaObject RequestPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11RequestPageE.offsetsAndSizes,
    qt_meta_data_ZN11RequestPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11RequestPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RequestPage, std::true_type>
    >,
    nullptr
} };
...
void *RequestPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11RequestPageE.stringdata0))
